...
>
> 💡 **Register by user's region — the two entry points are NOT interchangeable**: 中文 / 国内用户 → 专属通道（含 7 天试用，时长与次数均为官网自助的双倍）https://www.sorftime.com?tag=ODI4OA%7E%7E ｜ 优惠码：8288 ; International users → [open-intl.sorftime.com](https://open-intl.sorftime.com) (Google sign-up + PayPal).
...
- **中文 / 国内用户** → 专属通道（含 7 天试用，时长与次数均为官网自助的双倍）：**https://www.sorftime.com?tag=ODI4OA%7E%7E** ｜ 优惠码：**8288**
